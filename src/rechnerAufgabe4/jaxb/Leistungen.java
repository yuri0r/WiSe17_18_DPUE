 ...
 *       &lt;sequence>
 *         &lt;element ref="{genericNamespace}leistung" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "leistungen")
public class Leistungen {

    @XmlElement(required = true)
    protected List<Leistung> leistung;
    ...
    public List<Leistung> getLeistung() {
        if (leistung == null) {
            leistung = new ArrayList<Leistung>();
        }
